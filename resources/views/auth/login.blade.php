    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(../../assets/images/big/auth-bg32.jpg) no-repeat center center;">
            <div class="auth-box">
                            ...
                            <form class="form-horizontal m-t-20" id="loginform" action="/login" method="post">
                                ...
                                <div class="form-group m-b-0 m-t-10">
                                    <div class="col-sm-12 text-center">
                                        Don't have an account? <a href="CreateProfile.html" class="text-info m-l-5"><b>Sign Up</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div id="recoverform">
                    <div class="logo">
                        <span class="db"><img src="../../assets/images/logo-icon2.png" alt="logo" /></span>
						<h3 class="font-medium m-b-20" style="padding:20px;">Recover Password</h3>
